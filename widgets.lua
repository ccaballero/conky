...
function conky_widgets()
    ...
    round_rect(70, 240, 130, 1, 0, color, 0.5)
    round_rect(70, 405, 130, 1, 0, color, 0.5)
    round_rect(70, 520, 130, 1, 0, color, 0.5)
    round_rect(70, 660, 210, 1, 0, color, 0.5)
    round_rect(70, 908, 210, 1, 0, color, 0.5)

    round_rect(350, 405, 280, 1, 0, color, 0.5)
    round_rect(350, 590, 280, 1, 0, color, 0.5)
    round_rect(350, 913, 280, 1, 0, color, 0.5)
    ...
    ring('cpu', 'cpu2', 100, color, 0.2, color, 0.8, 276, 241, r-(14*7)+3, 5, 120, 180)
    ring('cpu', 'cpu3', 100, color, 0.2, color, 0.8, 276, 241, r-(14*7)+3, 5, 210, 270)
    ring('cpu', 'cpu4', 100, color, 0.2, color, 0.8, 276, 241, r-(14*7)+3, 5, 300, 360)
    ring('cpu', 'cpu5', 100, color, 0.2, color, 0.8, 276, 241, r-(13*7)+3, 5, 360, 420)
    ring('cpu', 'cpu6', 100, color, 0.2, color, 0.8, 276, 241, r-(13*7)+3, 5, 450, 510)
    ring('cpu', 'cpu7', 100, color, 0.2, color, 0.8, 276, 241, r-(13*7)+3, 5, 540, 600)
    ring('cpu', 'cpu8', 100, color, 0.2, color, 0.8, 276, 241, r-(13*7)+3, 5, 630, 690)

    ring('memperc',  '', 100, color, 0.2, color, 0.8, 276, 405, r-(15*7), 5, 0, 360)
    ring('swapperc', '', 100, color, 0.2, color, 0.8, 276, 405, r-(14*7), 5, 90, 270)
    ...
    then
        draw_cover(694, 880, 60, 60, 4, color)
    end

    ring('mpd_percent', '', 100, color, 0.2, color, 0.8, 390, 964, r-(14*7), 5, 0, 360)
